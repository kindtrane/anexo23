  ...
  <footer><span><center><img src="./img/Imagen1.png" class="img-responsive"/></center></span></footer>
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a>Consulta de Oficinas</a></li>
              </ul>
            </div>
          </div>
        </nav>
    ...
    <div class="container marketing">
      ...
      <hr class="featurette-divider">
          <div align="center">
          <label><h3>Seleccione una instancia</h3></label><br>
          <select type="text" name="instancia" class="form-control">
            <?php echo $combobyte; ?>
          </select>
          <br><br>
         <center> <input class="btn btn-primary" name="submit" type="submit" value="Ver" /></center>
         </div>
      </form>
    </div>
